...
class WR_Nitro_Update
{
    ...
    public static function admin_init()
    {
        ...
        register_setting('nitro_automatic_update', 'nitro_customer', [__CLASS__, 'validate']);
    }
    ...
    public static function validate($input)
    {
        ...
        remove_filter('sanitize_option_nitro_customer', [__CLASS__, 'validate']);
