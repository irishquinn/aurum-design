...
class WR_Nitro_Widgets_Social extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        $list_social = empty($instance['list_social']) ? [] : unserialize($instance['list_social']);
        ...
        if ($multicolor == 1) {
            ...
            switch ($style) {
                case 'style-custom':
                        if (empty($icon_color)) {
                            $classes[] = 'outline';
                        } elseif (empty($icon_color) && empty($background_color)) {
                            $classes[] = 'solid';
                        }
                    break;
                default:
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        if (in_array($new_instance['style'], ['style-default', 'style-custom'])) {
    ...
    public function form($instance)
    {
        ...
        $links = $instance['list_social'] ? unserialize($instance['list_social']) : [];
