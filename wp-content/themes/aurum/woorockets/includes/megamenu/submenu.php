...
class WR_Nitro_Megamenu_Submenu
{
    ...
    {
        if (!$list_product || !is_plugin_active('woocommerce/woocommerce.php')) {
            return false;
        }
    ...
    {
        if (!$list_category || !is_plugin_active('woocommerce/woocommerce.php')) {
            return false;
        }
        ...
        foreach ($list_category as $val) {
            ...
            if ($categories) {
                $image = WR_Nitro_Megamenu::get_image_term_product_category($val, [300, 300]);
