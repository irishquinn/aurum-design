...
class WR_Nitro_Sidebar
{
    ...
    public static function initialize()
    {
        ...
        add_action('wp_ajax_nitro_add_sidebar', [__CLASS__, 'add']);
        add_action('wp_ajax_nitro_remove_sidebar', [__CLASS__, 'remove']);

        // Register necessary actions to manage custom sidebars.
        add_action('init', [__CLASS__, 'init']);
        add_action('sidebar_admin_page', [__CLASS__, 'manage']);
    ...
    public static function add()
    {
        ...
        $sidebars['nitro-sidebar-' . $sidebar_num] = [
