    ...
    public static function html($meta, $field)
    {
		...
		<div id="<?php echo esc_attr($field['id']); ?>">
			<div class="wr-field-typography-group">
				<label class="font-italic <?php if (( int ) $meta['italic']) {
            echo 'active';
        } ?>">
				...
				<label class="font-underline <?php if (( int ) $meta['underline']) {
                            echo 'active';
                        } ?>">
				...
				<label class="font-uppercase <?php if (( int ) $meta['uppercase']) {
                            echo 'active';
                        } ?>">
