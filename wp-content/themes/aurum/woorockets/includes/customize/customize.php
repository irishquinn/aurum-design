...
class WR_Nitro_Customize
{
    ...
    public static function initialize($wp_customize)
    {
        ...
        foreach ($theme_options as $section => $define) {
            ...
            $settings = isset($define['settings']) ? $define['settings'] : [];
            $controls = isset($define['controls']) ? $define['controls'] : [];

            // Unset settings and controls data.
            unset($define['settings'] , $define['controls']);
            ...
            foreach ($settings as $setting => $define) {
                ...
                if ($wp_customize) {
                    $wp_customize->add_setting($setting, array_merge(['sanitize_callback' => null], $define));
                }
            }
        ...
        if ($wp_customize) {
            ...
            add_action('customize_controls_print_footer_scripts', [__CLASS__, 'print_footer_scripts']);
    ...
    public static function customize_assets()
    {
        ...
        wp_enqueue_script('wr-customize-control', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/customize.js', ['jquery', 'customize-controls'], '', true);
        ...
        wp_localize_script('wr-customize-control', 'wr_customize_messages', [
    ...
    {
        wp_enqueue_script('wr-customize-preview', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/preview.js', ['jquery', 'customize-preview'], '', true);
        wp_enqueue_script('wr-customize-actions', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/actions.js', ['jquery'], '', true);
    }
