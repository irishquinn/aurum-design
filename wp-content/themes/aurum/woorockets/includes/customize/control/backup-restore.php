...
class WR_Nitro_Customize_Control_Backup_Restore extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        ...
        if (!isset($enqueued)) {
            ...
            wp_enqueue_script('wr-nitro-customize-backup-restore', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/control/backup-restore.js', [], '1.0.0', true);

            wp_localize_script('wr-nitro-customize-backup-restore', 'wr_nitro_customize_backup_restore', [
                'type' => $this->type,
