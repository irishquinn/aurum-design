...
class WR_Nitro_Customize_Control_Typography extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        ...
        if (!isset($enqueued)) {
            ...
            wp_enqueue_script('wr-nitro-customize-typography', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/control/typography.js', ['spectrum-color-picker'], '1.0.0', true);

            wp_localize_script('wr-nitro-customize-typography', 'wr_nitro_customize_typography', [
                'type' => $this->type,
    ...
    public function render_content()
    {
        ...
        $default = wp_parse_args($this->settings['default']->default, [
            'family' => '',
            'bold' => '',
            'italic' => '',
            'underline' => '',
		...
		<div class="customize-control-content" id="wr-<?php echo esc_attr($this->type); ?> - <?php echo esc_attr($this->id); ?>">
			...
			<div class="customize-control-style">
				<div class="customize-control-typography-group">
					...
					<label class="font-italic <?php if ($value['italic']) {
                    echo ' active';
                } ?>">
					...
					<label class="font-underline <?php if ($value['underline']) {
                            echo ' active';
                        } ?>">
					...
					<label class="font-uppercase <?php if ($value['uppercase']) {
                            echo ' active';
                        } ?>">
