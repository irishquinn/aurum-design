...
class WR_Nitro_Customize_Control_Upload_Font extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        ...
        if (!isset($enqueued)) {
            ...
            wp_enqueue_script('wr-nitro-customize-upload-font', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/control/upload-font.js', [], '1.0.0', true);

            wp_localize_script('wr-nitro-customize-upload-font', 'wr_nitro_customize_upload_font', [
                'type' => $this->type,
    ...
    public function render_content()
    {
		...
		<div class="customize-control-content" id="wr-<?php echo esc_attr($this->type); ?> - <?php echo esc_attr($this->id); ?>">
			<div class="preview-font" style="margin:0 0 1em 0;border:1px dashed lightgray;padding:.75em 1em;background:#fff;"><?php
                esc_html_e('The quick brown fox jumps over the lazy dog', 'wr-nitro'); ?></div>
