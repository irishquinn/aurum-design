...
class WR_Nitro_Customize_Control_Colors extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        ...
        if (!isset($enqueued)) {
            ...
            wp_enqueue_style('spectrum-color-picker', get_template_directory_uri() . '/assets/3rd-party/spectrum/spectrum.css', [], '1.7.1');
            wp_enqueue_script('spectrum-color-picker', get_template_directory_uri() . '/assets/3rd-party/spectrum/spectrum.js', [], '1.7.1', true);

            // Enqueue custom control script.
            wp_enqueue_script('wr-nitro-customize-colors', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/control/colors.js', ['spectrum-color-picker'], '1.0.0', true);

            wp_localize_script('wr-nitro-customize-colors', 'wr_nitro_customize_colors', [
                'type' => $this->type,
