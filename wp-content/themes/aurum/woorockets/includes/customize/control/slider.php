...
class WR_Nitro_Customize_Control_Slider extends WP_Customize_Control
{
    ...
    public function enqueue()
    {
        ...
        if (!isset($enqueued)) {
            ...
            wp_enqueue_script('wr-nitro-customize-slider', get_template_directory_uri() . '/assets/woorockets/js/admin/customize/control/slider.js', ['jquery-ui-slider'], '1.0.0', true);

            wp_localize_script('wr-nitro-customize-slider', 'wr_nitro_customize_slider', [
                'type' => $this->type,
            ]);
    ...
    public function render_content()
    {
		...
		<div class="customize-control-content wr-slider" id="wr-<?php echo esc_attr($this->type); ?> - <?php echo esc_attr($this->id); ?>">
			<input type="range" value="<?php echo esc_attr($value); ?>" default-value="<?php
                echo esc_js($this->settings['default']->default); ?>" data-highlight="true">
