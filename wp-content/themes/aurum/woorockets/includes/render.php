...
class WR_Nitro_Render
{
    ...
    public static function enqueue_scripts()
    {
        ...
        wp_register_script('owl-carousel', get_template_directory_uri() . '/assets/3rd-party/owl-carousel/owl.carousel.min.js', [], false, true);
        wp_register_script('isotope', get_template_directory_uri() . '/assets/3rd-party/isotope/isotope-pkgd.min.js', [], false, true);
        wp_register_script('skrollr', get_template_directory_uri() . '/assets/3rd-party/skrollr/skrollr.min.js', [], false, true);
        wp_register_script('jquery-animation', get_template_directory_uri() . '/assets/3rd-party/jquery-animation/jquery-animation.min.js', [], false, true);
        wp_register_script('jquery-countdown', get_template_directory_uri() . '/assets/3rd-party/jquery-countdown/jquery.countdown.js', [], false, false);
        wp_register_script('nivo-lightbox', get_template_directory_uri() . '/assets/3rd-party/nivo-lightbox/nivo-lightbox.min.js', [], false, true);
        wp_register_script('magnific-popup', get_template_directory_uri() . '/assets/3rd-party/magnific-popup/jquery-magnific-popup.min.js', [], false, true);
        wp_register_script('scrollreveal', get_template_directory_uri() . '/assets/3rd-party/scrollreveal/scrollreveal.min.js', [], false, true);

        // Jquery Scrollbar
        if (is_singular('product')) {
            wp_enqueue_style('scrollbar', get_template_directory_uri() . '/assets/3rd-party/jquery-scrollbar/jquery.scrollbar.css');
            wp_enqueue_script('scrollbar', get_template_directory_uri() . '/assets/3rd-party/jquery-scrollbar/jquery.scrollbar.min.js', [], false, true);
        }
        ...
        wp_enqueue_script('wr-nitro-functions', get_template_directory_uri() . '/assets/woorockets/js/functions.js', ['jquery'], false, true);
        ...
        add_action('wp_ajax_nopriv_get_google_plus_count', [__CLASS__, 'get_google_plus_count']);
        add_action('wp_ajax_get_google_plus_count', [__CLASS__, 'get_google_plus_count']);

        add_filter('wr_font_url', ['WR_Nitro_Helper', 'filter_google_font']);
    ...
    public static function fonts_url()
    {
        ...
        if ($body_font_type == 'google') {
            if (isset($wr_nitro_options['body_google_font']['family'])) {
                ...
                $font_weight = [esc_attr($wr_nitro_options['body_google_font']['fontWeight'])];
        ...
        if ($heading_font_type == 'google') {
            if (isset($wr_nitro_options['heading_google_font']['family'])) {
                ...
                $font_weight = [esc_attr($wr_nitro_options['heading_google_font']['fontWeight'])];
    ...
    {
        // Get theme options.
        $css = $boxed_image = $page_title_image = [];
        ...
        if (!$wr_nitro_options['use_global']) {
            ...
            if (isset($page_bg_image_id)) {
                ...
                if (isset($page_bg_image_size) && $page_bg_image_size) {
                    $body_bg_image[] = 'background-size: ' . $page_bg_image_size . ';';
                }
                if (isset($page_bg_image_repeat) && $page_bg_image_repeat) {
                    $body_bg_image[] = 'background-repeat: ' . $page_bg_image_repeat . ';';
                }
                if (isset($page_bg_image_position) && $page_bg_image_position) {
                    $body_bg_image[] = 'background-position: ' . $page_bg_image_position . ';';
                }
                if (isset($page_bg_image_attachment) && $page_bg_image_attachment) {
                    $body_bg_image[] = 'background-attachment: ' . $page_bg_image_attachment . ';';
                }
            }
        } else {
...
CSS;
     ...
     * @return  void
     */
    public static function render_template($style, $args = [])
    {
        self::$style = $style;
     ...
     * @return  void
     */
    public static function render_content($style, $args = [])
    {
