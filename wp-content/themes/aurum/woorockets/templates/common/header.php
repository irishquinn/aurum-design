...
$wr_nitro_header_css = $wr_nitro_header_html = $wr_nitro_header_fonts = [];
...
$wr_hb_settings = WR_Nitro_Header_Builder::array_fillter_recursive(
    ...
    isset($wr_nitro_header_data['settings']) ? $wr_nitro_header_data['settings'] : []
);
...
foreach ($wr_hb_settings['style'] as $key => $val) {
    ...
    if ($key == 'backgroundImage') {
        ...
        } elseif ($wr_hb_settings['type'] == 'horizontal' && $wr_hb_settings['position'] == 'fixed') {
...
$wr_nitro_header_html[] = '<div class="header-outer clear ' . $wr_class_position . '" data-id="' . WR_Nitro_Header_Builder::prop('id') . '" ' . WR_Nitro_Helper::schema_metadata(['context' => 'header', 'echo' => false]) . '>';
											...
											<div class="search-inner">
												<div class=" search-form ' . (($wr_hb_item['layout'] == 'full-screen' || $wr_hb_item['layout'] == 'topbar') ? 'hb-search-fs' : '') . '">
                                                    ...
                                                    if ($wr_hb_item['liveSearch']['active'] == 1 && $wr_is_wrls_activated) {
                                                        ...
                                                        $wr_nitro_header_html[] = '
														<form class="' . $wr_class_outer . '" action="' . esc_url(home_url('/')) . '" method="get" role="search" ' . WR_Nitro_Helper::schema_metadata(['context' => 'search_form', 'echo' => false]) . '>
                                ...
                                case 'menu':
                                    ...
                                    if (!$wr_is_mobile) {
                                        ...
                                        if ((int) $wr_hb_item['menuID'] > 0 && is_nav_menu((int) $wr_hb_item['menuID'])) {
                                            ...
                                            $wr_nitro_header_html[] = '
												<div ' . WR_Nitro_Helper::schema_metadata(['context' => 'nav', 'echo' => false]) . ' class="' . implode(' ', $wr_classes_item_outer) . '"' . ((!($wr_hb_settings['type'] == 'horizontal' && $wr_hb_item['layoutStyle'] == 'text')) ? ' data-effect-vertical="' . esc_attr($wr_hb_item['subMenu']['effectNormalVertical']) . '"' : null) . '>';
                                        ...
                                        } elseif ((int) $wr_hb_item['textSettings']['fontSize'] > 0) {
                                ...
                                case 'logo':
                                    ...
                                    $wr_nitro_header_html[] = '<div class="' . implode(' ', $wr_classes_item) . '"' . ($wr_hb_item['ID'] ? (' id="' . esc_attr($wr_hb_item['ID']) . '"') : null) . '>';
                                        $wr_nitro_header_html[] = '<div class="content-logo"><a href="' . esc_url(home_url('/')) . '">';
                                            ...
                                            // Logo image
                                            } elseif ($wr_hb_item['logoType'] == 'image' && $wr_hb_item['logoImage']) {
                                                $wr_logo_retina = '';
                                    ...
                                    foreach ($wr_hb_item['style'] as $key_sub_item => $val_sub_item) {
                                        ...
                                        if ($key_sub_item == 'backgroundImage') {
                                            ...
                                            if ($wr_hb_item['logoType'] == 'text') {
                                                $wr_font_name = esc_attr($val_sub_item);
                                                $wr_font_weight = [($wr_hb_item['style']['fontWeight']) ? esc_attr($wr_hb_item['style']['fontWeight']) : '400'];
