...
<div class="<?php echo esc_attr(WR_Nitro_Render::$content_class) . (is_customize_preview() ? ' customizable customize-section-page' : ''); ?>" <?php WR_Nitro_Helper::schema_metadata(['context' => 'entry']); ?>>
	...
	<?php while (have_posts()) : the_post(); ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php WR_Nitro_Helper::schema_metadata(['context' => 'entry_content']); ?>>
