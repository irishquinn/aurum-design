...
<div class="<?php
        ...
        if ($wr_nitro_options['blog_single_social_share']) {
            echo ' has-social-share';
        }
        if ('1' == $wr_post_title && 'no-sidebar' != $wr_layout) {
            echo ' mgt30';
        }
        if ($wr_layout == 'right-sidebar') {
            echo ' right-sidebar';
        }
    ?>">
	...
	<div class="b-single">
		...
		<?php while (have_posts()) : the_post(); ?>
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> <?php WR_Nitro_Helper::schema_metadata(['context' => 'entry']); ?>>
				...
				<div class="entry-content">
					...
					<div class="content" <?php WR_Nitro_Helper::schema_metadata(['context' => 'entry_content']); ?>>
						<?php the_content(); ?>
					</div>
					...
					<?php
                        if ($wr_nitro_options['blog_single_author']) {
                            $wr_author = WR_Nitro_Helper::schema_metadata(['context' => 'author', 'echo' => false]);
                            $wr_author = sprintf(
