...
if (in_array($source, ['media_library', 'featured_image']) && 'yes' === $add_caption) {
...
$output = '
	<div class="' . esc_attr(trim($css_class)) . '">
		' . wpb_widget_title(['title' => $title, 'extraclass' => 'wpb_singleimage_heading']) . '
