...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr($product_id); ?> icon_color">
	...
	<?php else: ?>
		<a class="pr db <?php echo esc_attr($wr_btn_class); ?>" href="<?php echo esc_url(add_query_arg(['wishlist_notice' => 'true', 'add_to_wishlist' => $product_id], get_permalink(wc_get_page_id('myaccount'))))?>" rel="nofollow" class="<?php echo str_replace('add_to_wishlist', '', $link_classes) ?>" >
			<i class="nitro-icon-<?php echo esc_attr($wr_icons); ?>-wishlist"></i>
