...
<div id="product-<?php the_ID(); ?>" <?php post_class('style-2 social-circle ' . $layout . (is_customize_preview() ? ' customizable customize-section-product_single' : '')); ?>>
    ...
    echo 'container';
		...
		<div class="fc fcw<?php if ('right-sidebar' == $layout) {
    echo ' right-sidebar';
} ?>">
			<div id="shop-detail">
				<div class="container">
					<div class="row">
						<div class="w667-12 <?php echo($layout != 'no-sidebar' ? ' cm-5' : 'cm-3'); ?>">
			...
			<?php if ($layout != 'no-sidebar') : ?>
				<div id="shop-sidebar" class="primary-sidebar <?php if ($sticky == true) {
                    echo 'primary-sidebar-sticky';
                } ?> widget-style-<?php echo esc_attr($w_style) . ' ' . (is_customize_preview() ? 'customizable customize-section-widget_styles ' : ''); ?> mgt30">
					<?php if ($sticky == true) {
                    echo '<div class="primary-sidebar-inner">';
                } ?>
