	...
	<div class="form-container login <?php echo esc_attr($wr_class_login); ?>">
		<form class="woocommerce-form woocommerce-form-login login" method="post" id="login">
			...
			<div class="form-row form-row-wide">
				<div class="username"><input type="text" class="input-text" name="username" id="username" placeholder="<?php esc_attr_e('Username', 'wr-nitro'); ?>" value="<?php if (!empty($_POST['username'])) {
			...
			<form class="register" method="post" id="register">
				...
				<?php if ('no' === get_option('woocommerce_registration_generate_username')) : ?>
					...
					<div class="form-row form-row-wide">
						...
						<div class="username"><input type="text" placeholder="<?php esc_attr_e('Username', 'wr-nitro'); ?>" class="input-text" name="username" id="reg_username" value="<?php if (!empty($_POST['username'])) {
    echo esc_attr($_POST['username']);
} ?>" /></div>
					</div>
				...
				<div class="form-row form-row-wide">
					<div class="email"><input type="email" placeholder="<?php esc_attr_e('Email', 'wr-nitro'); ?>" class="input-text" name="email" id="reg_email" value="<?php if (!empty($_POST['email'])) {
