...
if ($wc_measurement_price_calculator) {
    echo sprintf(
        '<a href="%s" rel="nofollow" data-product_id="%s" data-product_sku="%s" data-quantity="%s" class="' . (($ajax_add_to_cart) ? 'ajax_add_to_cart' : '') . ' product__btn_cart product__btn ' . $class_icon,
