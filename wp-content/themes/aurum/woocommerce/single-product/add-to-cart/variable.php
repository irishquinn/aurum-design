...
<form class="variations_form pr cart<?php echo esc_attr($class); ?>" method="post" enctype='multipart/form-data' data-product_id="<?php echo absint($product->get_id()); ?>" data-product_variations="<?php echo htmlspecialchars(json_encode($available_variations)) ?>">
	...
	<?php else : ?>
				...
				<div class="attribute_item fc aic">
					...
					<div class="value">
						<?php
                            ...
                            wc_dropdown_variation_attribute_options(['options' => $options, 'attribute' => $attribute_name, 'product' => $product, 'selected' => $selected]);
		...
		<div class="single_variation_wrap<?php if ('1' != $single_style) {
                            echo ' mgt10';
                        } ?><?php echo esc_attr($class); ?>" style="display:none;">
			<?php
                /**
