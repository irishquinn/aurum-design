...
?>
<div id="product-<?php the_ID(); ?>" <?php post_class( 'style-2 social-circle tc-aurum ' . $layout . ( is_customize_preview() ? ' customizable customize-section-product_single' : '' ) ); ?>>
	<div class="oh pdt30 <?php if ( 'no-sidebar' != $layout ) echo 'container' ?>">
		<div class="fc fcw<?php if ( 'right-sidebar' == $layout ) echo ' right-sidebar' ?>">
			<div id="shop-detail">
				<div class="container">
					<div class="row sp-aurum">
						<div class="w667-12 <?php echo ( $layout != 'no-sidebar' ? ' cm-6' : 'cm-6' ); ?>">
						...
						<div class="w667-12 <?php echo ( $layout != 'no-sidebar' ? ' cm-7' : 'cm-6' ); ?>">
							<div class="p-single-info">
								<?php
										...
										//	echo '<div class="cxs-12 cm-1 f-left mt20"></div>';
										echo '<div>';
												...
												$url = get_term_link ($category->term_id );
													echo '<a class="sp-child" href="';
													echo $url;
													echo '">';
													echo $category->name;
													echo '</a>';
													echo'<h2 class="sp-title">';
														WR_Nitro_Helper::page_title();
													echo '</h2>';
													echo '</div>';
										//	echo '<div class="cxs-12 cm-8 f-left mt20"></div>';
											}
								?>
								<?php
									/**
